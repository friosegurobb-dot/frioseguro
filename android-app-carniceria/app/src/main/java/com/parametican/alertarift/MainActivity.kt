...
class MainActivity : AppCompatActivity() {
    ...
    private val reefers = mutableListOf(
        ReeferInfo("CARNICERIA-01", "Local Centro", true, -18.5f, false),
        ReeferInfo("CARNICERIA-02", "Local Norte", false, -17.0f, false),
        ReeferInfo("CARNICERIA-03", "Local Sur", false, -19.5f, false),
        ReeferInfo("CARNICERIA-04", "Local Este", false, -16.0f, false),
        ReeferInfo("CARNICERIA-05", "Local Oeste", false, -18.0f, false),
        ReeferInfo("CARNICERIA-06", "Depósito Central", false, -22.0f, false)
    )
